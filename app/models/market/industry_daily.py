...
class IndustryDaily(Base):
    ...
    industry_return_1m = Column(Numeric(12, 4), nullable=True, comment="行业1月收益率")
    industry_net_inflow = Column(Numeric(20, 4), nullable=True, comment="行业净资金流入(万元)")
    industry_pe = Column(Numeric(14, 4), nullable=True, comment="行业PE")
    industry_pe_mean_3y = Column(Numeric(14, 4), nullable=True, comment="行业3年PE均值")
    industry_pb = Column(Numeric(14, 4), nullable=True, comment="行业PB")
    industry_turnover = Column(Numeric(12, 4), nullable=True, comment="行业换手率")
