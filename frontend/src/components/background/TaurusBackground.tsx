  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      for (const star of starsRef.current) {
        const twinkle =
          star.opacity * (0.5 + Math.sin(t * star.twinkleSpeed + star.twinklePhase) * 0.4);
        ctx.beginPath();
