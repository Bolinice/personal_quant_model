  ...
  const handlePay = async () => {
    ...
    try {
      ...
      if (data.success) {
        setSnackbar({
          open: true,
          message: `${t.btn.subscribeSuccess} 有效期至 ${data.end_date}`,
          severity: 'success',
        });
            ...
            >
              ...
              >
                ...
                <Box sx={{ mb: 1.5 }}>
                  ...
                  {plan.price_unit && (
                    <Typography sx={{ fontWeight: 700, fontSize: '1.1rem', color: '#22d3ee' }}>
                      {plan.price_unit}
                    </Typography>
                  )}
                </Box>
            ...
            <GlassPanel glow glowColor="#22d3ee" sx={{ p: 4 }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'baseline', gap: 1, mb: 3 }}>
                {selectedPlan.price_yearly && (
                  <>
                    <Typography sx={{ fontWeight: 800, fontSize: '2.5rem', color: '#22d3ee' }}>
                      ¥{selectedPlan.price_yearly}
                    </Typography>
              ...
              >
                {paying
                  ? t.btn.paying
                  : selectedPlan.price_yearly
                    ? `${t.btn.subscribe} ¥${selectedPlan.price_yearly}/年`
                    : t.btn.contactSales}
              </Button>
            </GlassPanel>
          </motion.div>
