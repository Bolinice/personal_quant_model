...
def calculate_simulated_portfolio_nav_endpoint(portfolio_id: int, trade_date: str, db: Session = Depends(SessionLocal)):
...
def update_simulated_portfolio_endpoint(portfolio_id: int, updates: dict, db: Session = Depends(SessionLocal)):
