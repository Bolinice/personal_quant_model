...
| 文档版本 | V3.0 |
| 关联文档 | PRD V3.0、算法与工作流设计说明书 V3.0 |
| 文档状态 | 评审版 |
...
## 4.4 前端
- 管理后台 + 客户前台：React 19 + TypeScript 6 + Vite 8 + MUI v9
- 图表：Recharts 3.8
...
| V3.0 | 2026-05-01 | 文档版本升级V3.0；更新前端技术栈（React 19 + MUI v9 + Recharts）；更新调度方案（Celery Beat）；修正系统定位（量化研究与回测分析平台）；修正§3.8重复编号；关联文档更新为V3.0版本 |
