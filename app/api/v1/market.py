...
# def read_trading_calendar(exchange: str, start_date: str, end_date: str, is_open: bool = None, db: Session = Depends(get_db)):
...
# def read_stock_financial(ts_code: str, start_date: str, end_date: str, report_type: str = None, db: Session = Depends(get_db)):
...
# def read_stock_industry(ts_code: str, trade_date: str, db: Session = Depends(get_db)):
...
# def read_stock_basic(ts_code: str, db: Session = Depends(get_db)):
...
# def create_trading_calendar_endpoint(calendar_data: TradingCalendarCreate, db: Session = Depends(get_db)):
#     return create_trading_calendar(calendar_data, db=db)

# @router.post("/stock-financial", response_model=StockFinancialOut)
# def create_stock_financial_endpoint(financial_data: StockFinancialCreate, db: Session = Depends(get_db)):
#     return create_stock_financial(financial_data, db=db)

# @router.post("/stock-industry", response_model=StockIndustryOut)
# def create_stock_industry_endpoint(industry_data: StockIndustryCreate, db: Session = Depends(get_db)):
#     return create_stock_industry(industry_data, db=db)

# @router.post("/stock-basic", response_model=StockBasicOut)
# def create_stock_basic_endpoint(basic_data: StockBasicCreate, db: Session = Depends(get_db)):
