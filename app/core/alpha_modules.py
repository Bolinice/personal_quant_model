...
class QualityGrowthModule(AlphaModuleBase):
    ...
    FACTOR_CONFIG = {
        ...
        "operating_cashflow_ratio": {"direction": 1, "weight": 0.15}, # 现金流/净利润: 识别盈余质量, 高应计利润往往伴随盈利操纵
...
class ResidualMomentumModule(AlphaModuleBase):
    ...
    FACTOR_CONFIG = {
        ...
        "turnover_ratio_20d": {"direction": -1, "weight": 0.10},  # 方向-1: 高换手削弱动量(A股特有: 高换手=投机, 动量不可持续)
...
class RiskPenaltyModule(AlphaModuleBase):
    ...
    FACTOR_CONFIG = {
        ...
        "idiosyncratic_vol": {"direction": -1, "weight": 0.20},    # 特质波动率: 无法被系统性风险解释的波动, A股IVOL异象显著
