      ...
      <Box sx={{
        ...
        <Box sx={{ width: '100%', maxWidth: 400 }}>
          ...
          <Box component="form" onSubmit={handleSubmit}>
            <TextField
              fullWidth label={t('auth.newPassword')} type={showPassword ? 'text' : 'password'} value={password}
            ...
            />
            <TextField
              fullWidth label={t('auth.confirmPassword')} type={showPassword ? 'text' : 'password'} value={confirmPassword}
          ...
          <Box sx={{ textAlign: 'center' }}>
            <Link component={RouterLink} to="/login" sx={{ color: '#818cf8', fontWeight: 500, textDecoration: 'none', '&:hover': { textDecoration: 'underline' } }}>
              {t('auth.backToLogin')}
            </Link>
          </Box>
        </Box>
